...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-03-2025 a las 02:38:04
...
('Accesorios', 'Sucursal Norte', 30000000.00),
('Clásicas', 'Sucursal Central', 50000000.00),
('Graduación', 'Sucursal Oeste', 25000000.00),
('Honor', 'Sucursal Sur', 45000000.00),
('Personalizadas', 'Sucursal Central', 60000000.00),
('Universitarias', 'Sucursal Este', 70000000.00);
...
('00128', 'Sarai Fuentes Pertuz', NULL, 'Activo'),
('1131', 'Pablo Velez Altamiranda', NULL, 'Activo'),
('12345', 'Maria Paula', NULL, 'Activo'),
('19991', 'Sofia Beleño Castro', NULL, 'Activo'),
('2468', 'Juan Jaramillo', NULL, 'Activo'),
('54321', 'William Alvarez Quiroz', NULL, 'Activo'),
('55739', 'Sarah Sanchez Voz', NULL, 'Activo'),
('64567', 'Pedro Suarez', NULL, 'Activo'),
('76543', 'Ana Maria Del Mar Rios', NULL, 'Activo');
...
('10101', 'Avelina Alfaro', NULL, 3500000.00),
('1102798', 'Carlos Alfaro', NULL, 2780000.00),
('12121', 'Winner Acosta Lastre', NULL, 2900000.00),
('15151', 'Maria Castro Feria', NULL, 4500000.00),
('18181', 'Amanda Sevilla Lara', NULL, 3500000.00),
('22222', 'Elizabeth Perez Alviz', NULL, 4950000.00),
('32343', 'Camila Villegas Oslo', NULL, 4600000.00),
('45565', 'Katty Saenz Moron', NULL, 3750000.00),
('58583', 'Carmen Alma Vega', NULL, 5620000.00),
('76766', 'Ramiro Rojas PErez', NULL, 3720000.00),
('83821', 'Brenda Osorio Bertel', NULL, 3920000.00),
('98345', 'Amir Salas Martinez', NULL, 3800000.00);
...
CREATE TABLE `lineaproductos` (
  ...
  `sec_id` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
('A-2453', 'Jean Mujer Negro Atypical', NULL, 210000),
('C-A033A', 'Bralette Beige Lined Invisible Calvin Klein', NULL, 199920),
('C-A425AT', 'Camisa Raya Clasica Roja', NULL, 44900),
('CA425AT', 'Camisa Chalis Negra Deusero', NULL, 64900),
('LE-580', 'Jean Skinny Fit Indigo Oscuro Lee', NULL, 144990),
('LE044AT', 'Camiseta Azul Navy-Rojo Levis', NULL, 99900),
('M-104596', 'Vestido Largo Mujer Azul ', NULL, 70000),
('M-4465', 'Jean Mujer Azul Claro', NULL, 200000),
('M-P700A', 'Body Mujer Negro FI', NULL, 137100),
('M-P700AB', 'Pantalón Hombre Azul Mp', NULL, 80000),
('MP700AT', 'Camiseta Hombre Blanco Mp', NULL, 82500),
('R-106601', 'Vestido Corto Mujer Azul Petroleo', NULL, 82700),
('U-N070AB', 'Pantalon Hombre UNDER ARMOUR PJT RCK', NULL, 214950),
('V-E016A', 'Pantalón Chad Para Hombre Acabado Soft Negro', NULL, 389900);
...
('Local las Togas', '2', 149),
('Togas Sincelejo', '1', 109);
