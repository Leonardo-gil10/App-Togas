...
# ruta vestido
@app.route('/togas_clasicas')
def togas_clasicas():
    # Consulta de clientes (verifica si clientes tiene 'nombre_categoria')
    query1 = text("""
        SELECT c.id_cliente, c.nombre_cliente
        FROM clientes c
        JOIN categorias cat ON c.nombre_categoria = cat.nombre_categoria
        WHERE cat.nombre_categoria = 'Togas Clasicas'
    """)
    ...
    query2 = text("""
        ...
        FROM productos p
        JOIN categorias cat ON p.nombre_categoria = cat.nombre_categoria
        WHERE cat.nombre_categoria = 'Togas Clasicas'
    """)
    ...
    query3 = text("""
        ...
        FROM empleados e
        JOIN categorias cat ON e.nombre_categoria = cat.nombre_categoria
        WHERE cat.nombre_categoria = 'Togas Clasicas'
    """)
    ...
    try:
        ...
        flash(f"Se produjo un error al obtener los datos: {str(e)}", "danger")

    return render_template("vestidos.html", cliente=cliente, producto=producto, empleado=empleado)

# ruta pantalones
@app.route('/togas_honor')
def  togas_honor():
    # Consulta de clientes (verifica si clientes tiene 'nombre_categoria')
    query1 = text("""
        SELECT c.id_cliente, c.nombre_cliente
        FROM clientes c
        JOIN categorias cat ON c.nombre_categoria = cat.nombre_categoria
        WHERE cat.nombre_categoria = 'Togas de Honor'
    """)
...
# ruta ropa interior
@app.route('/birretes_accesorios')
def  birretes_accesorios():
    ...
    query1 = text("""
        ...
        FROM clientes c
        JOIN categorias cat ON c.nombre_categoria = cat.nombre_categoria
        WHERE cat.nombre_categoria = 'Birretes y Accesorios'
    """)
...
# ruta jeans
@app.route('/togas_personalizadas')
def  togas_personalizadas():
     # Consulta de clientes (verifica si clientes tiene 'nombre_categoria')
    query1 = text("""
        SELECT c.id_cliente, c.nombre_cliente
        FROM clientes c
        JOIN categorias cat ON c.nombre_categoria = cat.nombre_categoria
        WHERE cat.nombre_categoria = 'Togas Personalizadas'
    """)
...
# ruta camisetas
@app.route('/fotografia_graduacion')
def  camisetas():
     # Consulta de clientes (verifica si clientes tiene 'nombre_categoria')
    query1 = text("""
        SELECT c.id_cliente, c.nombre_cliente
        FROM clientes c
        JOIN categorias cat ON c.nombre_categoria = cat.nombre_categoria
        WHERE cat.nombre_categoria = 'Fotografía de Graduación'
    """)
...
# ruta camisas
@app.route('/togas_universitarias')
def  togas_universitarias():
     # Consulta de clientes (verifica si clientes tiene 'nombre_categoria')
    query1 = text("""
        SELECT c.id_cliente, c.nombre_cliente
        FROM clientes c
